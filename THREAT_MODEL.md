...
| T3 | Artifact tampering during release | Insider / compromised CI | Distributed malicious binaries | Very Low | Mitigated |
...
| M2 | GitHub Actions pinned to specific versions | T2 | Implemented |
| M3 | goreleaser produces checksums; only `OWNERS` approve release commits | T3 | Implemented |
